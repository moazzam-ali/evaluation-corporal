    ...
    return (
      <div className="flex flex-col items-center justify-center" style={{ minHeight: "70vh" }}>
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center">
          ...
          <p style={{ fontFamily: "var(--font-fraunces)", fontSize: "24px", fontWeight: 300, color: "#2F2F2B" }}>
            {t("scan.analyzing", "Analyzing your skin...")}
          </p>
          <div className="mt-6 w-full max-w-xs">
            <div style={{ height: "4px", borderRadius: "999px", background: "rgba(155,133,115,0.18)", overflow: "hidden" }}>
              <div
                style={{
                  height: "100%",
            ...
            <p className="mt-2 text-center" style={{ fontFamily: "var(--font-dm-sans)", fontSize: "11px", letterSpacing: "0.06em", color: "#6B5B4B" }}>
          ...
          <button
            ...
            style={{
              ...
              color: "#6B5B4B", padding: "8px 16px", borderRadius: "999px",
              border: "1.5px solid rgba(47,47,43,0.16)", background: "transparent", cursor: "pointer",
            }}
          >
    ...
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center px-6 text-center">
        <motion.div
          ...
          className="mx-auto w-full max-w-md rounded-3xl border border-[rgba(47,47,43,0.10)] bg-white p-8 shadow-sm"
        >
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-[#EAEFE6]">
            <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="#8D9A84" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="mb-6 text-[14px] leading-relaxed text-[#6B5B4B]" style={{ fontFamily: "var(--font-dm-sans)" }}>
          ...
          <div className="rounded-xl border border-[rgba(155,133,115,0.2)] bg-[#EFE7DC] px-4 py-3 text-[13px] leading-relaxed text-[#6B5B4B]" style={{ fontFamily: "var(--font-dm-sans)" }}>
  ...
  return (
    <div className="mx-auto max-w-[1280px]" style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: "56px", padding: "48px 32px 80px" }}>
      ...
      <aside className="hidden md:block" style={{ position: "sticky", top: "96px", alignSelf: "start" }}>
        ...
        {/* Title */}
        <h1 style={{ fontFamily: "var(--font-fraunces)", fontWeight: 300, fontSize: "36px", color: "#2F2F2B", margin: "0 0 6px", lineHeight: 1.1, letterSpacing: "-0.01em" }}>
          {t("scan.rail_title_1", "Tell us about")} <em style={{ fontStyle: "italic", color: "#9B8573", fontWeight: 400 }}>{t("scan.rail_title_2", "your skin.")}</em>
        </h1>
        ...
        <div className="flex justify-between mb-7" style={{ fontFamily: "var(--font-dm-sans)", fontSize: "11px", letterSpacing: "0.06em", color: "#6B5B4B" }}>
      ...
      >
        ...
        >
          <div className="min-w-0">
            <div
              ...
              style={{ fontFamily: "var(--font-dm-sans)", fontSize: "11px", letterSpacing: "0.16em", textTransform: "uppercase", color: "#9B8573" }}
            >
        ...
        >
          ...
          <span className="hidden sm:inline-flex items-center gap-2.5" style={{
            fontFamily: "var(--font-dm-sans)", fontSize: "12px", color: "#6B5B4B", whiteSpace: "nowrap",
          }}>
