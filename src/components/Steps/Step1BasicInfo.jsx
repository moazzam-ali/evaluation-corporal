    ...
    <div className="flex flex-col gap-[22px]">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step1.name", "First name")} <span className="text-[#9B8573] text-sm">*</span></label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step1.surname", "Last name")} <span className="text-[#9B8573] text-sm">*</span></label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step1.birthDate", "Date of birth")} <span className="text-[#9B8573] text-sm">*</span></label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step1.phone", "Phone")} <span className="text-[#9B8573] text-sm">*</span></label>
      ...
      <div className="flex items-start gap-3 rounded-xl border border-[rgba(47,47,43,0.10)] bg-[#F8F6F2] p-4">
        <input
          ...
          {...register("consent")}
        />
        <label htmlFor="consent" className="text-[12.5px] leading-relaxed text-[#4A4A42] cursor-pointer" style={{ fontFamily: "var(--font-dm-sans)" }}>
