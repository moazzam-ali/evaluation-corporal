  ...
  return (
    <div className="flex flex-col gap-[22px]">
      ...
      <div className="flex flex-col gap-2">
        <label className="scan-label">{t("scan.step2.sex", "Sex")} <span className="text-[#2C5BFF] text-sm">*</span></label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step2.weight", "Weight (kg)")} <span className="text-[#2C5BFF] text-sm">*</span></label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step2.height", "Height (cm)")} <span className="text-[#2C5BFF] text-sm">*</span></label>
      ...
      {/* Measurement intro */}
      <div className="rounded-xl border border-[rgba(11,27,51,0.10)] bg-[#F8FAFE] p-4">
        <p className="text-[13px] leading-relaxed text-[#5A6B85]" style={{ fontFamily: "var(--font-inter)" }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step2.waist", "Waist measurement (cm)")} <span className="text-[#2C5BFF] text-sm">*</span></label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="scan-label">{t("scan.step2.hip", "Hip measurement (cm)")} <span className="text-[#2C5BFF] text-sm">*</span></label>
