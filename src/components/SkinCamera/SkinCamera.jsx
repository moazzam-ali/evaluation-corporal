  ...
  return (
    <div className="flex flex-col gap-[18px]">
      ...
      <div
        ...
        style={{
          background: "#F6EDE3", padding: "4px", borderRadius: "14px",
      ...
      >
        <button
          ...
          style={{
            ...
            color: activeTab === "camera" ? "#1A1A2E" : "#6B6B7A",
            boxShadow: activeTab === "camera" ? "0 2px 6px rgba(26,26,46,0.08)" : "none",
        ...
        <button
          ...
          style={{
            ...
            color: activeTab === "upload" ? "#1A1A2E" : "#6B6B7A",
            boxShadow: activeTab === "upload" ? "0 2px 6px rgba(26,26,46,0.08)" : "none",
            transition: "background 220ms, color 220ms, box-shadow 220ms",
          }}
        >
        ...
        <div className="flex flex-col gap-[18px]">
          <div
            ...
            style={{
              ...
              background: "linear-gradient(160deg, #2A2A42 0%, #1A1A2E 100%)",
            ...
            {capturedImage ? (
                ...
                <div className="absolute bottom-5 left-0 right-0 flex justify-center">
                  <button
                    ...
                    style={{
                      ...
                      background: "rgba(255,255,255,0.94)", color: "#1A1A2E",
              ...
              <>
                ...
                <div className="absolute bottom-5 left-0 right-0 flex items-center justify-center gap-3.5">
                  ...
                  >
                    <span style={{ width: "50px", height: "50px", borderRadius: "50%", background: "white", boxShadow: "inset 0 0 0 2px #E8728A", display: "block" }} />
                  </button>
                </div>
              </>
            )}
          ...
          <div
            ...
            style={{ background: "#FDEEF1", border: "1px solid rgba(232,114,138,0.20)", borderRadius: "14px", padding: "14px 16px" }}
          >
            <span
              className="inline-flex items-center justify-center shrink-0"
              style={{ width: "28px", height: "28px", borderRadius: "8px", background: "white", color: "#E8728A" }}
            >
            ...
            <p style={{ margin: 0, fontSize: "13px", color: "#2D2D40", lineHeight: 1.55 }}>
              <strong style={{ color: "#1A1A2E", fontWeight: 600 }}>{t("scan.camera_help_title", "Hold steady — we auto-capture the sharpest frame.")}</strong>{" "}
        ...
        <div className="flex flex-col gap-[18px]">
          {uploadedImage ? (
            ...
            <label
              ...
              style={{
                border: isDragActive ? "2px solid #E8728A" : "2px dashed rgba(26,26,46,0.16)",
                borderRadius: "18px", padding: "56px 24px",
                background: isDragActive ? "#FDEEF1" : "#FDF8F3",
                minHeight: "320px",
            ...
            >
              ...
              <span
                ...
                style={{ width: "64px", height: "64px", borderRadius: "18px", background: "white", border: "1px solid rgba(26,26,46,0.10)", color: "#E8728A", marginBottom: "16px" }}
              >
              ...
              <span style={{ fontFamily: "var(--font-cormorant)", fontSize: "22px", fontWeight: 400, color: "#1A1A2E", lineHeight: 1.25 }}>
                {t("scan.upload_title_1", "Drag & drop your photo here,")} <em style={{ fontStyle: "italic", color: "#E8728A" }}>{t("scan.upload_title_2", "or click to browse.")}</em>
              </span>
              <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase", color: "#6B6B7A", marginTop: "8px" }}>
                {t("scan.upload_formats", "JPG, PNG · up to 10 MB")}
              </span>
              <span
                style={{
                  fontFamily: "var(--font-dm-sans)", fontSize: "13px", fontWeight: 500,
                  color: "white", background: "#E8728A", padding: "9px 18px",
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: "13px", color: "#2D2D40", lineHeight: 1.55 }}>
              <strong style={{ color: "#1A1A2E", fontWeight: 600 }}>{t("scan.upload_help_title", "Photos are processed, never permanently stored.")}</strong>{" "}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        {[
          ...
          <div
            ...
            style={{ background: "#FDF8F3", border: "1px solid rgba(26,26,46,0.10)", borderRadius: "12px", padding: "14px" }}
          >
            <span
              className="inline-flex items-center justify-center"
              style={{ width: "28px", height: "28px", borderRadius: "8px", background: "#FDEEF1", color: "#E8728A" }}
            >
              {tip.icon}
            </span>
            <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: "12.5px", fontWeight: 500, color: "#1A1A2E", lineHeight: 1.35 }}>
              {tip.text}
            </span>
          </div>
        ))}
